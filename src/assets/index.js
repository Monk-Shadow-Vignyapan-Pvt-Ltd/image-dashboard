import logo from './logo/logo-512.webp';
...
import imageLogo from './logo/final-logo.svg';

export {
    logo, person1, person2, person3, person4, india, uk, hongkong, germany, china, ireland, loginImg, cardImg, visa, imageLogo
}
